                                    ...
                                    <div className="bloque-libro" key={index}>
                                        ...
                                        <div className="imagenes-libro">
                                            ...
                                            {!isBotonDeshabilitado &&
                                                <a href={`/blog/alumno/${usuario}/citasAlumno?ISBN13=${encodeURIComponent(libro.ISBN13)}&titulo=${encodeURIComponent(libro.titulo)}&usuario=${encodeURIComponent(usuario)}`}
                                                >
