...
const Principal = () => {
  ...
  //Obtenemos las ultimas reservas con el get al API actualizarReserva leer 
  ...
  //Para obtener las estadisticas de los mas pedidos con un GET a API actualizarReservas leer
      ...
      <Layout content={
        <>
          ...
          <div className="seccion-igual-1">
            ...
            <Link href={`/index/admin/${usuario}/paginaUltimasReservas`} class="ver-todo">Ver todo</Link>
          </div>
