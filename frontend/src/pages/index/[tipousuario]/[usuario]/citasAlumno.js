                ...
                <div className='seccionInfoLibro'>
                    <div className='infoizquierda'>
                        ...
                        <div className='debajoheader'>
                            ...
                            <div className='inforLibro'>
                                    <h3 className='parrafos'>"Sumérgete en el fascinante mundo de la informática con nuestro último libro, 'Código Creativo: Explorando la Ciencia de la Computación'. Este libro te llevará en un emocionante viaje a través de los conceptos fundamentales de la programación, desde algoritmos simples hasta proyectos de inteligencia artificial de vanguardia. Descubre cómo los códigos pueden dar vida a tus ideas, creando aplicaciones, sitios web y programas sorprendentes. Ya seas un principiante curioso o un programador experimentado, este libro te desafiará y te inspirará a explorar nuevas posibilidades en el vasto mundo de la informática. ¡Prepárate para desatar tu creatividad y dar rienda suelta a tu potencial como programador!"</h3>
                                </div>
