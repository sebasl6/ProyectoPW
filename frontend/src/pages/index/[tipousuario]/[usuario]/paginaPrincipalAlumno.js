...
const Principal = () => {
  ...
  // Recorre el objeto de alumno usando forEach
  ...
  //Ultimos resultados atraves del get API de actualizarReservas leer
  ...
  //Los libros mas pedidos 
  const [stats, setStats] = useState([])
  //lo usamos para obtener estadisticas usando un get a API actualizarStats leer 
        ...
        <>
          <div className="contenidoizquierda">
            <div className="opciones">
              <ul>
                <li><Link href={`javascript:location.reload(true);`}>Principal</Link></li>
